...
WebDriver oBrowser;
	...
	public void Everification()
	{
		...
		if(sExpectedLAtext.contains(sActualLAtext))
		{
		...
		{
			System.out.println(" In Words Loan Amount displayed is not correct");
		...
		if(sExpectedCalEMI.equals(sActualCalEMI)) 
		{
		...
		{
			System.out.println("Calculated EMI is not correct");
		}
